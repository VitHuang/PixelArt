...
function initPixelShader() {
	pixelShader = createShader(getShader(gl, "pixel-vs"), getShader(gl, "pixel-fs"));
...
function initTextureShader() {
	textureShader = createShader(getShader(gl, "texture-vs"), getShader(gl, "texture-fs"));
...
function initNormalShader() {
	normalShader = createShader(getShader(gl, "normal-vs"), getShader(gl, "normal-fs"));
...
function initDepthShader() {
	depthShader = createShader(getShader(gl, "depth-vs"), getShader(gl, "depth-fs"));
...
function initSobelShader() {
	sobelShader = createShader(getShader(gl, "sobel-vs"), getShader(gl, "sobel-fs"));
...
function initCannyShader() {
	cannyShader = createShader(getShader(gl, "canny-vs"), getShader(gl, "canny-fs"));
...
function drawModel(shader, model) {
	...
	mat4.translate(mvMatrix, [0.0, -20.0, -250.0]);
